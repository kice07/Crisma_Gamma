<div class="navbar">
    ...
    <div class="end">
        ...
        <div class="counter">
            ...
            <span style="top:3%; right:13%">2</span>
        </div>
        ...
        <a href="profile.php" class="profile"><img src=<?php echo ($_SESSION['image']  == '') ? "freelancer_dashboard_assets/images/freelancer/no_user.png" : "freelancer_dashboard_assets/images/freelancer/" . $_SESSION['image'] ?> style="border:1px solid #19202b" alt=""></a>
    </div>
</div>
