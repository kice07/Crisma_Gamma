...
include("../../../config.php");
session_start();
$user_id = $_SESSION['unique_freelancer_id'];
if (isset($_POST['action'])) {
    ...
    $get_query = mysqli_query($conn, "SELECT DISTINCT daynumber FROM task WHERE daynumber >= {$jourDuMois} AND rest ='{$moisEtAnnee}' ORDER BY  daynumber ASC, task_id ASC");
