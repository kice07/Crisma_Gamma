...
$outgoing_id = 816858279;
$incoming_id = $_POST['company'];
...
if (!isset($_FILES['file'])) {
    ...
    $parentDirectoryPath = '../pdf_sent/freelancer-' . $outgoing_id . "/"; // Chemin du répertoire parent
    $fileP = 'freelancer_dashboard_assets/pdf_sent/freelancer-'. $outgoing_id . "/";
